...
Let $V(x): \mathbb{X} \rightarrow \mathbb{R}$ be a continuously differentiable positive definite function, i.e., $V(0) = 0$ and $V(x) > 0, \forall x \in \mathbb{X} \backslash \{ 0 \}$. If there exists $\rho > 0$ such that $\Omega := \{ x \in \mathbb{X} \mid V(x) \leq \rho \}$ is bounded and
\begin{equation}
