...
**Software.** Implementing a robust interior-point method that reliably solves *general* nonlinear programs is nontrivial. Fortunately, the open-source solver [IPOPT](https://github.com/coin-or/Ipopt) [@wachter2006implementation] is a mature, widely used option that exploits sparsity and supports exact or quasi-Newton Hessians. In what follows, we formulate several trajectory-optimization problems and solve them with IPOPT to illustrate end-to-end modeling and solver usage.
